...
//        }
    ...
    public void loadCreatureSprites() {
        ...
        for (int i=0; i<4; i++) {
            ...
            greenKnightAnim[i] = createGreenKnightAnim(
        ...
        greyknightSprite = new Fly(greyKnightAnim[0], greyKnightAnim[1],
    ...
    private Animation createGreenKnightAnim(Image img1, Image img2) {
        Animation anim = new Animation();
